...
const WhatsappStorySection = () => {
  return (
    <div className="px-6 md:px-20 py-12 bg-gradient-to-r from-[#F5F5DC] to-[#00A8AA]">
      ...
      {/* Content Section */}
      <div className="flex flex-col md:flex-row items-center justify-between gap-10 text-sm">
        {/* Animation Image */}
        <div className="w-full md:w-1/2">
          <img src={whatsappAnimation} alt="whatsapp-animation" className="w-full max-w-md mx-auto" />
        </div>
